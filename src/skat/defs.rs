...
pub use crate::consts::bitboard::{
    ACEOFCLUBS, ACEOFDIAMONDS, ACEOFHEARTS, ACEOFSPADES, ACES, ALLCARDS, CARDS, CLUBS,
    CONNECTION_BREAKER, DIAMONDS, EIGHTOFCLUBS, EIGHTOFDIAMONDS, EIGHTOFHEARTS, EIGHTOFSPADES,
    EIGHTS, GRAND_CONN, GRAND_CONN_EQ, HEARTS, JACKOFCLUBS, JACKOFDIAMONDS, JACKOFHEARTS,
    JACKOFSPADES, JACKS, KINGOFCLUBS, KINGOFDIAMONDS, KINGOFHEARTS, KINGOFSPADES, KINGS,
    NINEOFCLUBS, NINEOFDIAMONDS, NINEOFHEARTS, NINEOFSPADES, NINES, NULL_CLUBS, NULL_CONN_EQ,
    NULL_DIAMONDS, NULL_HEARTS, NULL_SPADES, QUEENOFCLUBS, QUEENOFDIAMONDS, QUEENOFHEARTS,
    QUEENOFSPADES, QUEENS, RANGE, RANGE_INV, SEVENOFCLUBS, SEVENOFDIAMONDS, SEVENOFHEARTS,
    SEVENOFSPADES, SEVENS, SPADES, SUIT_CONN, SUIT_CONN_EQ, TENOFCLUBS, TENOFDIAMONDS, TENOFHEARTS,
    TENOFSPADES, TENS, TRUMP_GRAND, TRUMP_NULL, TRUMP_SUIT,
};
